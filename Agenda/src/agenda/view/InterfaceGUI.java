  ...
  public void actionPerformed(ActionEvent evento)
   {
      ...
      if(evento.getSource() ==  bVerItem)
      {
         try
         {
            ...
            }else
            {
               ...
               {
                  areaTextoItem.setText("Informação sobre o item de código: " + opc + "\n\n" 
      ...
      if(evento.getSource() == bAtualizar)
      {
         ...
         try
         {
            ...
            JOptionPane.showInputDialog("Digite o código do item que deseja atualizar."));
            if(g.consultaPorCodigo(codigo) != "Item não localizado.")
            {
               janela.removeAll();
               janelaAtualizar(
               g.consultaDescricao(codigo), g.consultaLocal(codigo), g.consultaData(codigo), g.consultaStatus(codigo));
            }else
            {
      ...
      if(evento.getSource() == bOk)
      {
         int opc;
            ...
            boolean sucesso = g.adicionaValor(
            tDescricao.getText(),tLocal.getText(),tData.getText(),0   
            );
               if(sucesso == true)
               {
            ...
            {
               JOptionPane.showMessageDialog(null,"No campo confirmação digite:\n 1 - Para confirmar \nou \n 0 - Para cancelar"
               ,"Mensagem - Alerta",2);
            }      
      }
         ...
         if(evento.getSource() == bAtualizarItem)
         {
            ...
            boolean sucesso = g.adicionaValor(
            tDescricao.getText(),tLocal.getText(),tData.getText(),opc   
            );
               if(sucesso == true)
               {
